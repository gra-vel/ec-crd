...
nuevo_1015 <- act_flujo_migratorio(archivo = "007_ESI/entrada_ec_2023.xlsx", codigo_indicador = 1015, mes = 5, guardar = FALSE)
nuevo_1016 <- act_flujo_migratorio(archivo = "007_ESI/salida_ec_2023.xlsx", codigo_indicador = 1016, mes = 5, guardar = FALSE)
nuevo_1017 <- act_flujo_migratorio(archivo = "007_ESI/entrada_ex_2023.xlsx", codigo_indicador = 1017, mes = 5, guardar = FALSE)
nuevo_1018 <- act_flujo_migratorio(archivo = "007_ESI/salida_ex_2023.xlsx", codigo_indicador = 1018, mes = 5, guardar = FALSE)
...
nuevo_2014 <- act_deuda_IESS(archivo = "012_MEF/Base-de-Datos-Boletin-de-Deuda-MAR-2023.xls", mes = 3, año = 2023, guardar = FALSE)
...
nuevo_3004 <- act_deuda_publica(archivo = "012_MEF/Base-de-Datos-Boletin-de-Deuda-MAR-2023.xls", codigo_indicador = 3004, mes = 3, año = 2023, guardar = FALSE)
nuevo_3005 <- act_deuda_publica(archivo = "012_MEF/Base-de-Datos-Boletin-de-Deuda-MAR-2023.xls", codigo_indicador = 3005, mes = 3, año = 2023, guardar = FALSE)
nuevo_3006 <- act_deuda_publica(archivo = "012_MEF/Base-de-Datos-Boletin-de-Deuda-MAR-2023.xls", codigo_indicador = 3006, mes = 3, año = 2023, guardar = FALSE)
nuevo_3007 <- act_deuda_publica(archivo = "012_MEF/Base-de-Datos-Boletin-de-Deuda-MAR-2023.xls", codigo_indicador = 3007, mes = 3, año = 2023, guardar = FALSE)
...
nuevo_4002 <- act_detenidos(archivo = "018_MG/Detenidos/mdg_detenidosaprehendidos_pm_2023_enero_abril.xlsx", version = 2, codigo_indicador = 4002, año = 2023, guardar = FALSE)
nuevo_4003 <- act_detenidos(archivo = "018_MG/Detenidos/mdg_detenidosaprehendidos_pm_2023_enero_abril.xlsx", version = 2, codigo_indicador = 4003, año = 2023, guardar = FALSE)
...
nuevo_4007 <- act_snai(archivo = "020_SNAI/Reporte-semanal-PPL-CAI-25-mayo-2023.xlsx", codigo_indicador = 4007, año = 2023, guardar = FALSE)
nuevo_4008 <- act_snai(archivo = "020_SNAI/Reporte-semanal-PPL-CAI-25-mayo-2023.xlsx", codigo_indicador = 4008, año = 2023, guardar = FALSE)
nuevo_4009 <- act_armas(archivo = "018_MG/Armas/mdg_armasilicitas_2023_pm_enero-abril.csv", año = 2023, guardar = FALSE)
nuevo_4010 <- act_drogas(archivo = "018_MG/Drogas/mdi_sustanciasdepositadas_pm_2023_enero_abril.xlsx", año = 2023, guardar = FALSE)
